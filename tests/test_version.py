...
class TestPackageVersion:
    ...
    def test_version_is_2_2_0(self):
        """Test that current version is 2.2.0"""
        assert pyecod_mini.__version__ == "2.2.0"
...
class TestVersionConsistency:
    ...
    def test_version_consistency_across_components(self, domain_summary_path, temp_output_dir):
        ...
        assert package_version == writer_version == api_version == xml_version == "2.2.0"
    ...
    def test_version_in_all_outputs(self, domain_summary_path, temp_output_dir):
        ...
        # Check result object
        assert result.algorithm_version == "2.2.0"
        ...
        with open(output_path, "r") as f:
            xml_content = f.read()
            assert '2.2.0' in xml_content
            assert 'algorithm="2.2.0"' in xml_content
...
class TestVersionInMetadata:
    ...
    def test_partition_metadata_includes_version(self):
        ...
        # Can be set
        metadata.algorithm_version = "2.2.0"
        assert metadata.algorithm_version == "2.2.0"
